...
pub const protobuf = @import("codec/protobuf.zig");
...
pub const ProtobufDecoder = protobuf.Decoder;
pub const ProtobufEncoder = protobuf.Encoder;
pub const ProtobufLimits = protobuf.Limits;
pub const Varint32FrameDecoder = protobuf.Varint32FrameDecoder;
pub const Varint32Prepender = protobuf.Varint32Prepender;
